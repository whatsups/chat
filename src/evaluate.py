...
#from load import MAX_LENGTH, Voc
from loadData import loadPreparedData
from config import SOS_token,EOS_token,MAXLEN
from prepareData import sentence2index
from loadData import Voc
from model import *
...
def runTest(n_layers, hidden_size, modelFile, beam_size, corpus):
    checkpoint = None
    ...
    encoder = EncoderRNN(embedding,hidden_size,hidden_size,n_layers,bidirectional=False,dropout=0.1,rnn_type='LSTM')
    # 构建DeocderRNN
    # self,embedding,hidden_size,output_size,n_layers=1,rnn_type='LSTM',use_ATTN=False,dropout = 0.1
    decoder = DecoderRNN(embedding,hidden_size,voc.n_words,n_layers,rnn_type='LSTM',use_ATTN=True,dropout=0.1)
